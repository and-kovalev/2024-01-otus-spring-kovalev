...
class QuestionCsvRepositoryImplTest {
    ...
    void setUp() {
        ...
        Reader reader = new ReaderFromResourceFileImpl();
        questionRepository = new QuestionCsvRepositoryImpl(fileNameProvider, parser, reader);
    }
