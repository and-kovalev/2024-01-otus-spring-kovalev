...
import ru.otus.hw.repositories.jpa.JpaBookCommentsRepository;
...
class JpaBookCommentsRepositoryTest {
    ...
    @Autowired
    private JpaBookCommentsRepository jpaBookCommentsRepository;
    ...
    void shouldReturnCorrectBookCommentsById(long testId) {
        ...
        var expectedBookComments = em.find(JpaBookComments.class, testId);
    ...
    void shouldSaveNewBookComments() {
        var expectedBookComments = new JpaBookComments(0, BOOK_COMMENTS_OK,
    ...
    void shouldSaveUpdatedBookComments() {
        var expectedBookComments = new JpaBookComments(TEST_ID, BOOK_COMMENTS_OK,
                jpaBookRepository.findById(TEST_ID).get());
