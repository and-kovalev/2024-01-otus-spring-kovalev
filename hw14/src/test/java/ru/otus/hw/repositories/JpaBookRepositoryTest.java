...
class JpaBookRepositoryTest {
    ...
    void shouldReturnCorrectBookById(long testBook) {
        ...
        var expectedBook = em.find(JpaBook.class, testBook);
    ...
    void shouldSaveNewBook() {
        var expectedBook = new JpaBook(0, "BookTitle_10500",
    ...
    void shouldSaveUpdatedBook() {
        var expectedBook = new JpaBook(TEST_ID, "BookTitle_10500",
                jpaAuthorRepository.findById(TEST_ID).get(),
                jpaGenreRepository.findById(TEST_ID).get(),
                null);
    ...
    private List<JpaBook> getDbBooks() {
        return IntStream.range(1, 4).boxed()
                .map(id -> em.find(JpaBook.class, id))
                .toList();
    }
